...
Компиляция произведена в оболочке w64devkit от Christopher Wellons, репозиторий https://github.com/skeeto/w64devkit. Ошибок было весьма много и ИИ их титанически иправлял в течении многих часов. Это была тяжелая работа. По заверениям ИИ процесс компиляции такой:
```
